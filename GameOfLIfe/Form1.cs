...
namespace GameOfLife
{
    public partial class Form1 : Form
    {
        ...
        private void ZoomBar_ValueChanged(object sender, EventArgs e) { Reset(); }


        private void Reset(bool randomize = true)
        {
            board = new Board(pictureBox1.Width, pictureBox1.Height, (int)SizeNud1.Value);
            if (randomize)
        ...
        private void Reset(string startingPattern)
        {
            ...
            int yOffset = (board.data - lines.Length) / 2;
        ...
        private void Render()
        {
            ...
            {
                gfx.Clear(ColorTranslator.FromHtml("#000000"));
                ...
                {
                    for (int row = 0; row < board.data; row++)
                    {
